...
if($_SERVER["REQUEST_METHOD"]=="POST") {
    ...
    $err=false;
    if($usertype === "HR") {
      $check_query = "SELECT * FROM `hr_table` WHERE username='$username' AND password='$password'";
      $redirect_page = "home.php"; // Home page for HR
  } else {
      $check_query = "SELECT * FROM `users` WHERE username='$username' AND password='$password'";
      $redirect_page = "user.php"; // Home page for User
  }
  ...
  if($match) {
    ...
    header("Location: /Project/$redirect_page");
...
<body>
  ...
  <p class="login-failed-message">Contact your HR</p>
  <?php } ?>
  ...
  <form class="form" action="login.php" method="POST">
    ...
    <div class="radio-inputs">
      <label class="radio">
        <input type="radio" name="usertype" value="HR" checked="">
