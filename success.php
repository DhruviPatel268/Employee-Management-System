...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  if (isset( $_POST['idEdit'])){
    ...
    // Sql query to be executed
      ...
      $sql = "INSERT INTO `users` (`name`, `email`,`username`,`password`,`age`,`phone`,`joinDate`,`country`,`role`,`salary`) VALUES ('$name', '$email','$username','$password','$age','$phone','$joinDate','$country','$role','$salary')";
      $result = mysqli_query($conn, $sql);
